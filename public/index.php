...
$router->get('/ug/journal', 'UGControl@journal');
$router->post('/ug/journal/save', 'UGControl@saveJournal');
$router->post('/ug/journal/delete', 'UGControl@deleteJournal');
...
$router->post('/ug/editComment', 'UGControl@editComment');
$router->post('/ug/deleteComment', 'UGControl@deleteComment');
...
$router->post('/ug/quiz/save', 'UGControl@saveQuizResult');
...
$router->post('/Moderator/resource/unfreeze', 'ModeratorControl@unfreezeResource');

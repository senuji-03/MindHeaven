...
<style>
   ...
   ========================================================= */
    ...
    .donation-content .section-label {
        ...
        <div class="hero-inner">
            ...
            <div class="hero-visual">
                ...
                <div class="hero-card hero-card--main">
                    ...
                    <div
                        style="margin-top:16px; padding-top:14px; border-top:1px solid var(--border); font-size:0.78rem; color:var(--text-secondary);">
                        <i class="fas fa-calendar-check" style="color:var(--primary);"></i> Session with Dr. Sarah —
                        Tomorrow 2 PM
                    </div>
                </div>
                ...
                <div class="hero-card hero-card--stat">
                    ...
                    <div class="stat-icon-row">
                        ...
                        <div style="font-size:0.72rem;color:var(--text-secondary);align-self:center;margin-left:2px;">
                            Available now</div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="features-grid stagger-children">
            <div class="feature-card animate-on-scroll">
                ...
                <p>Schedule private, secure sessions with licensed university counselors. Get real support from real
                    professionals.</p>
            </div>
            <div class="feature-card animate-on-scroll">
                <div class="feature-icon feature-icon--apricot"><i class="fas fa-comments"></i></div>
                <h3>Peer Support Forum</h3>
                <p>Share anonymously with students who understand what you're going through. You're never the only one.
                </p>
            </div>
            <div class="feature-card animate-on-scroll">
                <div class="feature-icon feature-icon--sky"><i class="fas fa-brain"></i></div>
                <h3>Self-Assessment Quiz</h3>
                <p>Take a quick, private mental health check-in. Get instant feedback on anxiety, stress, and mood
                    patterns.</p>
            </div>
            <div class="feature-card animate-on-scroll">
                <div class="feature-icon feature-icon--forest"><i class="fas fa-book-open"></i></div>
                <h3>Resource Hub</h3>
                <p>Curated articles, videos, and guides designed for the unique challenges that come with university
                    life.</p>
            </div>
            <div class="feature-card animate-on-scroll">
            ...
            <div class="feature-card animate-on-scroll">
                ...
                <p>Log your mood, build healthy habits, and set wellness goals. Watch your growth over time — it
                    matters.</p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="steps-grid stagger-children">
            <div class="step-card animate-on-scroll">
                ...
                <p>Sign up with your university email in under two minutes. It's free, private, and completely
                    confidential.</p>
            </div>
            <div class="step-card animate-on-scroll">
                <div class="step-number">2</div>
                <h3>Take a wellness check</h3>
                <p>Complete a short self-assessment to understand where you are right now. No judgement — just insight.
                </p>
            </div>
            <div class="step-card animate-on-scroll">
...
<section id="fundraising-events" class="events-section">
    <div class="container">
        <div class="section-header animate-on-scroll">
                        ...
                        <?php foreach ($events as $event): ?>
                            <div class="event-card animate-on-scroll">
                                ...
                                <div class="event-card-body">
                                    ...
                                    <p><?= htmlspecialchars($event['short_description'] ?? 'Support this mental health initiative.') ?>
                                    </p>
    ...
    <section class="counselors-section">
        <div class="container">
            <div class="section-header animate-on-scroll">
                ...
                <p class="section-subtitle">Our licensed mental health professionals are here to support your journey toward
                    wellness.</p>
            </div>
                        ...
                        <div class="counselor-card-inner">
                            <div class="counselor-avatar-wrap">
                                <?php if ($pic): ?>
                                    ...
                                    <div class="counselor-avatar-initials" style="background:<?php echo $color; ?>; display:none;">
                                        <?php echo $initials; ?>
                                    </div>
                                <?php else: ?>
                                    <div class="counselor-avatar-initials" style="background:<?php echo $color; ?>;">
                                        <?php echo $initials; ?>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="counselor-card-body">
                                ...
                                <?php if ($exp !== null): ?>
                                    <div class="counselor-exp"><i class="fas fa-briefcase"></i> <?php echo $exp; ?>
                                        year<?php echo $exp !== 1 ? 's' : ''; ?> experience</div>
                                <?php endif; ?>
                                        ...
                                        foreach ($qualsToShow as $q): ?>
                                            <div class="counselor-qual-item">
                                                ...
                                                <?php if (!empty($q['description'])): ?>
                                                    <span
                                                        class="counselor-qual-desc"><?php echo nl2br(htmlspecialchars($q['description'])); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                            ...
                            <div class="counselor-card-footer">
                                <a href="<?php echo BASE_URL; ?>/ug/appointment"
                                    class="btn btn-primary counselor-book-btn btn-sm">
    ...
    <div class="container">
        <div class="donation-inner">
            <div class="donation-content animate-on-scroll">
                ...
                <p>No student should have to choose between their mental health and their budget. Your donation keeps
                    counseling sessions, crisis support, and every resource on this platform completely free for every
                    student who needs them.</p>

      ...
      <div class="api-interface">
        ...
        <div class="crisis-form" id="crisisForm" style="display: none;">
          ...
          <div class="form-group">
            ...
            <textarea id="crisisDescription" class="form-textarea"
              placeholder="Briefly describe what you're experiencing..."></textarea>
          </div>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="breathing-controls">
        ...
        <button id="stopBreathing" class="btn outline" onclick="stopBreathingExercise()"

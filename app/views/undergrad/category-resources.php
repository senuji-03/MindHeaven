    ...
    <div class="hero-content">
      ...
      <div class="hero-stats">
        <div class="hero-stat">
          ...
          <span class="stat-label">Resources Here</span>
        </div>
      </div>
    </div>
  </section>
...
.airbnb-cover img, .airbnb-cover .placeholder-icon {
    width: 100%;
    height: 100%;
    object-fit: cover;
      ...
      <div class="airbnb-card" onclick="openResource(<?= htmlspecialchars(json_encode($resource), ENT_QUOTES, 'UTF-8') ?>)">
        <div class="airbnb-cover">
            ...
            <?php elseif ($hasYoutube): ?>
                ...
                ?>
                <?php if ($ytId): ?>
                    <img src="https://img.youtube.com/vi/<?= $ytId ?>/hqdefault.jpg" alt="YouTube Thumbnail" style="width:100%;height:100%;object-fit:cover;">
                    <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;">
                        <div style="width:52px;height:52px;background:rgba(255,0,0,0.85);border-radius:50%;display:flex;align-items:center;justify-content:center;">
        ...
        <div class="airbnb-info">
           ...
           <div class="airbnb-meta">
               <?php if ($hasYoutube): ?><span style="color:#ff0000;font-size:0.8rem;font-weight:600;">▶ YouTube</span>&nbsp;<?php endif; ?>

        ...
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-item"><a href="<?php echo BASE_URL; ?>/counselor/sessionHistory">📋 Session
                        History</a></li>
                <li class="sidebar-item active"><a href="<?php echo BASE_URL; ?>/counselor/forum"
                        style="color: #2563eb;">💭 Forum</a></li>
                        ...
                        <div class="form-container">
                            ...
                            <form id="threadForm" action="<?= BASE_URL ?>/forum/create" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="help-text">Your username will be hidden, but moderators can still see
                                        it for
                                ...
                                <div class="form-actions">
                                    <button type="button" class="btn-secondary"
                                        onclick="toggleCreateThread()">Cancel</button>
                            ...
                            <?php if (empty($threads)): ?>
                                <div class="thread-item">
                                    <div class="thread-preview">
                                        <p style="text-align:center; color:#6b7280;">No conversations yet. Be the first to
                                            verify a
                                            thought!</p>
                                    </div>
                                </div>
